    ...
    >
      ...
      <SimpleBar className="h-[calc(100vh-100px)]">
        <div className="px-6">
          ...
          <div className="mt-8 rounded-xl border border-border bg-lightprimary p-4">
            <div className="flex items-center gap-2 text-primary"><Icon icon="solar:shield-check-linear" width={20} /><span className="text-sm font-semibold">Güvenli oturum</span></div>
            <p className="mt-2 text-xs leading-5 text-muted-foreground">Kimlik doğrulama HttpOnly cookie ve CSRF korumasıyla sağlanır.</p>
          </div>
        </div>
      </SimpleBar>
    </AMSidebar>
